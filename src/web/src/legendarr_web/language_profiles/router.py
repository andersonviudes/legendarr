...
async def _language_profile_form(
    ...
    ocr_embedded_subtitles: bool = Form(False),
    speech_to_text_fallback: bool = Form(False),
    forced: bool = Form(False),
    hearing_impaired: bool = Form(False),
    download_even_if_target_embedded: bool = Form(False),
    ...
    return {
        ...
        "ocr_embedded_subtitles": ocr_embedded_subtitles,
        "speech_to_text_fallback": speech_to_text_fallback,
        "forced": forced,
        "hearing_impaired": hearing_impaired,
        "download_even_if_target_embedded": download_even_if_target_embedded,
