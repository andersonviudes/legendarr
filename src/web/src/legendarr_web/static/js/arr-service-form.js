// Client-side guard for the arr-service "Test" button. The button lives in the page
// toolbar above the form (not inside it, so it can also submit the form via its
// `form="arr-service-form"` attribute) and is a plain type="button", so it bypasses
...
document.addEventListener("htmx:beforeRequest", function (event) {
  ...
  var form = document.getElementById("arr-service-form");
