...
- [legendarr opensubtitles hash hang fix](legendarr-opensubtitles-hash-hang-fix.md) — compute_opensubtitles_hash had no timeout, unlike every other blocking call; napiprojekt_hash still open
